...
>
    ...
    >
        <span
            aria-hidden="true"
            class="{{ $checked ? "translate-x-5" : "translate-x-0" }} pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out dark:bg-gray-200"
        ></span>
    </div>
